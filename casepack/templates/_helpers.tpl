...
Common labels
*/}}
{{- define "casepack.labels" -}}
helm.sh/chart: {{ include "casepack.chart" . }}
{{ include "casepack.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
app.kubernetes.io/part-of: casepack
{{- end }}

{{/*
Selector labels
*/}}
{{- define "casepack.selectorLabels" -}}
